...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  user = {
     ...
     * @tags User
     * @name UserNameSignIn
     * @request POST:/User/SignIn/Username
     * @secure
     */
    userNameSignIn: (data: UserNameSignInRequest, params: RequestParams = {}) =>
      this.request<UserNameSignInResponse, any>({
        path: `/User/SignIn/Username`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
